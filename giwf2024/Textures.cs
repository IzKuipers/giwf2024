...
namespace giwf2024
{
    ...
    {
        private readonly string[] TextureIds = { "coin", "player", "deathpoint", Configuration.emptyCell, "wall", "hdeathpoint", "#next", "Kgreen", "Kblue", "Kyellow", "kgreen_", "kblue_", "kblue_", "player_neutral", "player_happy", "player_jim", };
